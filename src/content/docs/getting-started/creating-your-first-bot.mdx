...
1. Go back to the <button class="blurple-btn">Bot</button> tab.

2. Click on the <button class="blurple-btn">Reset Token</button> button in the **TOKEN** section.

3. Click on the <button class="blurple-btn">Copy</button> button.
